      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 items-stretch">
          {features.map((f) => (
            <div
              key={f.title}
              className="group glass-card rounded-2xl p-4 sm:p-5 lg:p-6 h-full flex flex-col transition-all duration-300 hover:border-[oklch(0.7_0.24_295/0.5)] hover:-translate-y-0.5"
            >
              <div className="flex flex-col items-start gap-3 h-full">
                ...
                <div className="min-w-0 flex-1 flex flex-col">
                  <h3 className="text-sm sm:text-base font-bold text-white leading-tight min-h-[2.5rem] sm:min-h-0">
                    {f.title}
                  </h3>
