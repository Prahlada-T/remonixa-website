  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[#070314]/80 border-b border-white/5">
      <div className="relative mx-auto flex h-20 max-w-[1600px] items-center justify-center md:justify-between px-4 sm:px-6">
        ...
        >
          <span className="relative inline-flex h-16 w-16 sm:h-24 sm:w-24 items-center justify-center">
            ...
            <img
              ...
              width={96}
              height={96}
              className="relative h-16 w-16 sm:h-24 sm:w-24 object-contain drop-shadow-[0_0_10px_oklch(0.65_0.24_295/0.6)]"
            />
          </span>
